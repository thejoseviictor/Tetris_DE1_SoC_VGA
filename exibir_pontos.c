...
int exibir_pontos(int pontos)
{
    ...
    *HEX0_BASE = 0xff;
    ...
    //Definindo a unidade
        if(decomposto[1] == 0){ //Definindo unidade zerada
            
            *HEX3_BASE = 0xc0;
            //sleep(1);
        }
        else if(decomposto[1]==1){ //Definindo unidade 1
            
            *HEX3_BASE = 0xf9;
            //sleep(1);
        }
        else if(decomposto[1]==2){ //Definindo unidade 2
            
            *HEX3_BASE = 0x1a4;
            //sleep(1);
        }
        else if(decomposto[1]==3){ //Definindo unidade 3
            
            *HEX3_BASE = 0xb0;
            //sleep(1);
        }
        else if(decomposto[1]==4){ //Definindo unidade 4
            
            *HEX3_BASE = 0x99;
            //sleep(1);
        }
        else if(decomposto[1]==5){ //Definindo unidade 5
            
            *HEX3_BASE = 0x92;
            //sleep(1);
            
        }else if(decomposto[1]==6){ //Definindo unidade 6
            
            *HEX3_BASE = 0x82;
            //sleep(1);
        }
        else if(decomposto[1]==7){ //Definindo unidade 7
            
            *HEX3_BASE = 0xf8;
            //sleep(1);
        }
        else if(decomposto[1]==8){ //Definindo unidade 8
            
            *HEX3_BASE = 0x80;
            //sleep(1);
        }
        else if(decomposto[1]==9){ //Definindo unidade 9
    ...
    //Definindo a dezena:
        ...
        if(decomposto[0] == 0){ //Definindo dezena zerada
            
            *HEX4_BASE = 0xc0;
            //sleep(1);
        
        }
        else if(decomposto[0]==1){ //Definindo dezena 10
            
            *HEX4_BASE = 0xf9;
            //sleep(1);
        }
        else if(decomposto[0]==2){ //Definindo dezena 20
            
            *HEX4_BASE = 0x1a4;
            //sleep(1);
        }
        else if(decomposto[0]==3){ //Definindo dezena 30
            
            *HEX4_BASE = 0xb0;
            //sleep(1);
        }
        else if(decomposto[0]==4){ //Definindo dezena 40
            
            *HEX4_BASE = 0x99;
            //sleep(1);
        }
        else if(decomposto[0]==5){ //Definindo dezena 50
            
            *HEX4_BASE = 0x92;
            //sleep(1);
            
        }else if(decomposto[0]==6){ //Definindo dezena 60
            
            *HEX4_BASE = 0x82;
            //sleep(1);
        }
        else if(decomposto[0]==7){ //Definindo dezena 70
            
            *HEX4_BASE = 0xf8;
            //sleep(1);
        }
        else if(decomposto[0]==8){ //Definindo dezena 80
            
            *HEX4_BASE = 0x80;
            //sleep(1);
        }
        else if(decomposto[0]==9){ //Definindo dezena 90
